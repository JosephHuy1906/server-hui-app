...
class CheckoutController extends Controller
{
    ...
    public function updateStatus($id)
    {
        try {
            ...
            $notication->postNotification($find->user_id, 'user', 'Bạn đã thanh toán ' . $totalAmountPayable . 'đ tiền đấu hụi', $find->room_id);
            $notication->postNotification($find->user_id, 'admin', 'User đã thanh toán tiền' . $totalAmountPayable . 'đ đấu hụi', $find->room_id);
        } catch (\Throwable $e) {
